...
from app.clients.peltierpro.settings import ToolSettings
from app.integrations.odoo.client import OdooAPIError, OdooClient
from app.integrations.odoo.security import clamp_limit, clean_search, positive_id
